#
#  Be sure to run `pod spec lint ZSNetWorking.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/safiriGitHub/ZSNetWorking"
  ...
  s.source       = { :git => "https://github.com/safiriGitHub/ZSNetWorking.git", :tag => "#{s.version}" }
